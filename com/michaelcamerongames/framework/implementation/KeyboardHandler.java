...
import com.michaelcamerongames.framework.Input.KeyEvent;
...
public class KeyboardHandler implements OnKeyListener
{
	...
	public boolean onKey(View v, int keyCode, android.view.KeyEvent event)
	{
		...
		synchronized (this)
		{
			...
			if (event.getAction() == KeyEvent.KEY_DOWN)
			{
				keyEvent.type = KeyEvent.KEY_DOWN;
				if (keyCode > 0 && keyCode < 127)
					pressedKeys[keyCode] = true;
			}
			if (event.getAction() == KeyEvent.KEY_UP)
			{
		...
		return false;
		// I'm not sure why this returns false.  See Text page 198.
	}
